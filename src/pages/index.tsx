    ...
    <DefaultLayout>
      <div className="flex flex-col justify-center items-center gap-4 p-9">
        ...
        <div className="p-8 md:p-0 md:w-3/4 lg:w-2/3 xl:w-1/2">
          <p><strong>RelgerWeb</strong> - Ferramenta computacional de gerenciamento dos dados técnicos relacionados aos empreendimentos de geração fotovoltaica conectados ao sistema elétrico do RN [Versão 0.1 | Fevereiro/2024].</p>
